...
''' Fixed in general '''
parser.add_argument('--data_root_dir', default='E:/DeepLearning/multiweather/dataset/MultiWeather', type=str, help='save path')
...
parser.add_argument('-j', '--num_workers', default=1, type=int, metavar='INT', help='number of data loading workers (default: 4)')
parser.add_argument('--display_interval', default=200, type=int, metavar='M', help='display_interval') # 800
...
''' Train setting '''
parser.add_argument('--data', metavar='multiweather', help='dataset name (e.g. COCO2014')
parser.add_argument('--model_name', type=str, default='TDRG')
parser.add_argument('--save_dir', default='./checkpoint/multiweather/', type=str, help='save path')
