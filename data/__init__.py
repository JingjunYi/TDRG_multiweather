...
from .multiweather import Multiweather
...
def make_data_loader(args, is_train=True):
    ...
    elif args.data == 'multiweather':
        root_dir = args.data_root_dir
        val_dataset = Multiweather(root_dir, phase='test', transform=transform)
    else:
    ...
    if args.data == 'COCO2014':
        ...
        root_dir = args.data_root_dir
        train_dataset = Multiweather(root_dir, phase='trainval', transform=transform)
    else:
        raise NotImplementedError('Value error: No matched dataset!')
